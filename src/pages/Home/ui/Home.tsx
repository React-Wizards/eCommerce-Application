...
const Home = () => {
  ...
  const onSearchTextChangeHandler = async (e: ChangeEvent<HTMLInputElement>) => {
    if(e.target.value){
    ...
    <div className={styles.container}>
      <nav className={styles.nav}>
        ...
        <form
          ...
          >
          <input type='text' className={styles.searchInput} tabIndex={0} value={searchTextInput.value} onChange={onSearchTextChangeHandler}/>
          </label>
